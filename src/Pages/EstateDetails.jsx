...
const EstateDetails = () => {
    ...
    console.log(item)
    const { id, image, estate_title, segment_name, description, price, status, area, location, facilities } = item;
    return (
        <div>
            <Helmet>
                <title>Single Family Card Details | Home Rent</title>
            </Helmet>
            ...
            <div className="card border-2 bg-base-100 shadow-xl mt-16 mb-10">
                ...
                <div className="px-5 py-5 space-y-2 items-center ">
                    ...
                    <h3 className="text-lg "><span className="font-bold">Card Id:</span> {id}</h3>

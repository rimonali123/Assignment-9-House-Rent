...
const ApartmentDetails = () => {
    ...
    const { id3 } = useParams();
    const idInt = parseInt(id3);
    const apartment = apartments.find(apartment => apartment.id3 === idInt)
    console.log(apartment);
    const { image, estate_title, segment_name, description, price, status, area, location, facilities } = apartment;
    return (
        <div>
            <Helmet>
                <title>Apartment Details | Home Rent</title>
            </Helmet>
            <div className="card border-2 bg-base-100 shadow-xl mt-16 mb-10">
                ...
                <div className="px-5 py-5 space-y-2 items-center ">
                    ...
                    <h3 className="text-lg "><span className="font-bold">Card Id:</span> {id3}</h3>
